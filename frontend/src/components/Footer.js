      ...
      <div className="container">
        <div className={styles.top}>
          ...
          <p className={styles.brandTagline}>
            Instrumentos musicales seleccionados para principiantes y
            profesionales. Donde nace tu sonido.
          </p>
        ...
        <div className={styles.grid}>
          ...
          <div>
            ...
            <p className={styles.newsletterText}>
              Enterate de novedades y ofertas antes que nadie.
            </p>
        ...
        <div className={styles.bottom}>
          <span>&copy; {year} MusicTrack. Proyecto académico.</span>
